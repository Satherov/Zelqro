...
///
/// Represents a function that accepts a `long` argument and produces a result.
///
...
public interface LongFunction<R extends @Nullable Object> {
    ...
    ///
    default <V> Function<V, R> compose(ToLongFunction<? super V> before) {
        return value -> this.apply(before.applyAsLong(value));
    }
}
