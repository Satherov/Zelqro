...
///
@FunctionalInterface
public interface ByteFunction<R extends @Nullable Object> {
    ...
    ///
    default <V> Function<V, R> compose(ToByteFunction<? super V> before) {
        return value -> this.apply(before.applyAsByte(value));
    }
}
