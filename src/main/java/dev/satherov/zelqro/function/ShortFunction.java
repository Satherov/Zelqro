...
///
/// Represents a function that accepts a `short` argument and produces a result.
///
/// @param <R> The type of the result of the function.
///
@FunctionalInterface
public interface ShortFunction<R extends @Nullable Object> {
    ...
    ///
    default <V> Function<V, R> compose(ToShortFunction<? super V> before) {
        return value -> this.apply(before.applyAsShort(value));
    }
}
